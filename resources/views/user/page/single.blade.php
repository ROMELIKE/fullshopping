                                ...
                                <ul id="etalage">
                                    <li>
                                        <a href="optionallink.html">
                                            <img class="etalage_thumb_image" src="{{asset('user/images/s2.jpg')}}" class="img-responsive" />
                                            <img class="etalage_source_image" src="{{asset('user/images/s2.jpg')}}" class="img-responsive" title="" />
                                        </a>
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="{{asset('user/images/s2.jpg')}}" class="img-responsive" />
                                    ...
                                    <li>
                                        <img class="etalage_thumb_image" src="{{asset('user/images/s3.jpg')}}" class="img-responsive"  />
                                        <img class="etalage_source_image" src="{{asset('user/images/s3.jpg')}}"class="img-responsive"  />
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="{{asset('user/images/s4.jpg')}}" class="img-responsive"  />
                                        <img class="etalage_source_image" src="{{asset('user/images/s4.jpg')}}"class="img-responsive"  />
                                    </li>
                                </ul>
                                <div class="clearfix"></div>
                            </div>
