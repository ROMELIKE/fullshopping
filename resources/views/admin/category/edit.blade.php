...
@section('content')
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-5">Price</label>

                                <div class="col-sm-9">
                                    <div class="clearfix">
                                        <input class="" type="number" id="form-field-5" placeholder="price"/>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
											<span class="input-icon">
                                                <textarea name="" id="form-field-icon-1" cols="46" rows="5">
    ...
    <script src="{{asset('admin/js/spinbox.min.js')}}"></script>
    ...
    <script src="{{asset('admin/js/autosize.min.js')}}"></script>
    <script src="{{asset('admin/js/jquery.inputlimiter.min.js')}}"></script>
